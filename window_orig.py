...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Убрали вызов on_type_changed, если он не нужен
        # self.video_type.currentIndexChanged.connect(self.on_type_changed)
        ...
        self.sound.setValue(70)  # Значение по умолчанию
    ...
    def on_select_file(self):
        ...
        if file_path and os.path.exists(file_path):
            ...
            self.showEvent(None)
            self.setWindowTitle(f"Player - {os.path.basename(file_path)}")
    ...
    def convert_video(self, input_file, output_file, target_format):
        """Конвертация видео"""
        try:
            # Получаем пайплайн для конвертации
    ...
    def get_conversion_pipeline(self, input_file, output_file, target_format):
        """Создание пайплайна конвертации"""
        ...
        # Выбираем муксер в зависимости от формата
